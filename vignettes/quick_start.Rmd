...
The structure of the output is a list which contains 7 indicator given below and `arsenal::comparedf` object. For more details and useage of the `arsenal::comparedf`, please refer [vignettes](https://cran.r-project.org/web/packages/arsenal/vignettes/comparedf.html). 
...
- When new records are added to a table : class_match
