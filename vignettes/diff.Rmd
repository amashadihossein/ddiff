...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: |
  %\VignetteIndexEntry{The ddiff function}
...
provide actionable `diff` like functionality for data. The illustration below shows a comparison to implementing a diff functionality with packages dicussed above. ![ddiff appraoch](diff1_table.png){width=100%}
...
# Form or base content diff basic examples

We first build two data.frames to compare. The following test conditions are considered : 
