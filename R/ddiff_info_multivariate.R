...
#'
#' @description This function could obtain and compare custom multivariate summary statistics from given two datasets. Specially, the concurrent version involves obtaining the variance-covariance matrix of given two datasets
...
#' @examples
#' d = test_data()
#' #result = ddiff_info_multivariate(d$identical$new, d$identical$old, , c("ID", "Days"), c("nEggs" , "nEggsRemain"))
#' #result$result_con
#' #result$result_cat
#' #result$result_bin
#' @export
